...
enum class Hats (
    ...
    NERD_GLASSES_1(15, "§aNerd Glasses", Material.PAPER, 100018, "1.3.0"),
    ...
    FRONTMAN_MASK(42, "§eFrontMan Mask", Material.PAPER, 100045, "1.4.3"),
    SANTA_HAT(43, "§eSanta Hat", Material.PAPER, 100046, "1.4.3"),
    DEAR_HAT(44, "§6Dear Hat", Material.PAPER, 100047, "1.4.3"),
    SNOWMAN_HAT(45, "§fSnowman Hat", Material.PAPER, 100048, "1.4.3"),
    SILVESTER_GLASSES_1(46, "Silvester Glasses 1", Material.PAPER, 100049, "1.4.3"),
    SILVESTER_GLASSES_2(47, "Silvester Glasses 2", Material.PAPER, 100050, "1.4.3"),
    SILVESTER_GLASSES_3(48, "Silvester Glasses 3", Material.PAPER, 100051, "1.4.3"),
    PARTY_HAT(49, "§dParty Hat", Material.PAPER, 100052, "1.4.3"),
